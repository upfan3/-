...
{
#endif
	u8 w5500_checkConnet();
	int w5500_is_connected(uint8 sock);
	...
	void SPI_DMA_READ(uint8 *Addref, uint8 *pRxBuf, uint16 rx_len);
	void SPI_DMA_WRITE(uint8 *Addref, uint8 *pTxBuf, uint16 tx_len);
