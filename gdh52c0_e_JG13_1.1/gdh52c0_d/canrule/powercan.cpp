	     ...
	     pPcid=(PCid *)(&prbuf->id);
	       ...
	       if(CID1==UPDATA){   //升级
						...
						*/ 
							...
							gDcParam0[prbuf->data[0]-1].st_downModle=prbuf->data[1]; //下电模式
						  gDcParam0[prbuf->data[0]-1].st_LDVoltage=(*(u16 *)(&prbuf->data[2]));//下电电压
						  gDcParam1[prbuf->data[0]-1].st_LDDelay=(*(u16 *)(&prbuf->data[4]))*10; //下电时间
					}						
								  ...
								  if((CID2&0xff0)==0x100)
									{
								      ...
								      battBroadOnlineCount=30;
								      *((s16 *)&gpSysData[ACID_BATT_VOL])=*(s16 *)&prbuf->data[0];
								      *((s16 *)&gpSysData[BATT_CURR5])=*(s16 *)&prbuf->data[2];
								      *((s16 *)&gpSysData[BATT_CURR6])=*(s16 *)&prbuf->data[4];
								      *((u16 *)&gpSysData[ACID_BATT_STATUS])=*(u16 *)&prbuf->data[6];
							}
					}
				        ...
				        getEnergyFlag=0;
					     ...
					     if(setBattParaflag==1)
							 ...
							 else if(setBattParaflag==2)
							 {
								 ...
								 prbuf->data[0]=setPoint;
								 
								 if(setPoint == 4) setPoint = 1; //后台设置
								 prbuf->data[1]=gDcParam0[setPoint-1].st_downModle;
								 *(u16 *)&prbuf->data[2]=gDcParam0[setPoint-1].st_LDVoltage;
								 *(u16 *)&prbuf->data[4]=gDcParam1[setPoint-1].st_LDDelay/10;
								 *(u16 *)&prbuf->data[6]=gDcParam1[setPoint-1].st_LDEnergy;
