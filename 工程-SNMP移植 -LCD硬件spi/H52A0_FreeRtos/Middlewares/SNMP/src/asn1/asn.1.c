...
int asn_encode_end_of_mib_view(unsigned char *data)
{
    data[0]=END_OF_MIB_VIEW;
    data[1]=0;
    return 2;
}

int asn_encode_no_such_object(unsigned char *data)
{
    data[0]=NO_SUCH_OBJECT;
    data[1]=0;
    return 2;
}

int asn_encode_no_such_instance(unsigned char *data)
{
    data[0]=NO_SUCH_INSTANCE;
    data[1]=0;
    return 2;
}
